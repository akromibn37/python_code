...
class Circle:
    ...
    def line_in_circle(self,line): 
        ...
        if self.contain_point(line.x1, line.y1): # ถ้าจุดปลายของส่วนของเส้นตรงซักข้างอยู่ในวงกลม ให้คืนค่า True
            return True
        ...
        # ให้เช็คด้วยว่าใน 2 จุดนั้น มีซักจุดอยู่ในส่วนของเส้นตรงหรือไม่ ถ้าอยู่ให้คืนค่า True ถ้าไม่อยู่ให้คืนค่า False
            return line.contain_point(ret[1][0],ret[1][1]) or \
                   line.contain_point(ret[2][0],ret[2][1])
...
for i in range(n):
    ...
    if circle.line_in_circle(line): # ส่วนของเส้นตรงตัดหรือสัมผัสวงกลม
